<template>
    ...
    <div class="container" id="mainContainer">
        ...
        <el-table :data="weaponPackage" class="transparent-table">
            ...
            <el-table-column label="二级道具" width="180">
                <template #default="scope">{{ scope.row.wpName }}</template>
            </el-table-column>
            <el-table-column property="wpPrice" label="价格" width="120" />
