...
export const useCounterStore = defineStore('counter', {
  state: () => ({
    ...
    rangeRate: [
      { min: 0, max: 10000, value: 0.4 },
      { min: 10000, max: 18000, value: 0.37 },
      { min: 18000, max: 30000, value: 0.32 },
      { min: 30000, max: 40000, value: 0.3 },
      { min: 40000, max: 50000, value: 0.28 },
      { min: 50000, max: 60000, value: 0.27 },
      { min: 60000, max: 80000, value: 0.25 },
      { min: 80000, max: 100000, value: 0.22 },
      { min: 100000, max: 9007199254, value: 0.21 },
    ],
    levelObj: [
      { levelName: "紫色", levelPrice: 10 },
      { levelName: "橙色", levelPrice: 25 },
      { levelName: "金色", levelPrice: 30 },
    ],
    weaponPackage: [

      { wpName: "2021全球冠军赛", wpPrice: 800, url: new URL('@/assets/images/weapon/21.png', import.meta.url).href },
